...
func (x *ListArticleRequest) GetKeyword() string {
	if x != nil {
		return x.Keyword
	}
	return ""
...
func (x *ListArticleResponse) GetStatus() string {
	if x != nil {
		return x.Status
	}
	return ""
...
func (x *ListArticleResponse) GetTotal() int32 {
	if x != nil {
		return x.Total
	}
	return 0
...
var file_article_proto_rawDesc = []byte{
	...
	0x03, 0x72, 0x70, 0x63, 0x22, 0xd4, 0x01, 0x0a, 0x07, 0x41, 0x72, 0x74, 0x69, 0x63, 0x6c, 0x65,
	...
	0x01, 0x28, 0x03, 0x52, 0x08, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x49, 0x64, 0x12, 0x1d, 0x0a,
	...
	0x52, 0x09, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0x2e, 0x0a, 0x12, 0x4c,
	...
	0x28, 0x09, 0x52, 0x07, 0x6b, 0x65, 0x79, 0x77, 0x6f, 0x72, 0x64, 0x22, 0x6d, 0x0a, 0x13, 0x4c,
	...
	,
...
var file_article_proto_goTypes = []interface{}{
	(*Article)(nil),             // 0: rpc.Article
	(*ListArticleRequest)(nil),  // 1: rpc.ListArticleRequest
	(*ListArticleResponse)(nil), // 2: rpc.ListArticleResponse
}
var file_article_proto_depIdxs = []int32{
	0, // 0: rpc.ListArticleResponse.articles:type_name -> rpc.Article
	1, // 1: rpc.ArticleService.GetArticle:input_type -> rpc.ListArticleRequest
	2, // 2: rpc.ArticleService.GetArticle:output_type -> rpc.ListArticleResponse
...
type ArticleServiceClient interface {
	GetArticle(ctx context.Context, in *ListArticleRequest, opts ...grpc.CallOption) (*ListArticleResponse, error)
}
...
func (c *articleServiceClient) GetArticle(ctx context.Context, in *ListArticleRequest, opts ...grpc.CallOption) (*ListArticleResponse, error) {
	out := new(ListArticleResponse)
	err := c.cc.Invoke(ctx, "/rpc.ArticleService/GetArticle", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ArticleServiceServer interface {
	GetArticle(context.Context, *ListArticleRequest) (*ListArticleResponse, error)
}
...
func (*UnimplementedArticleServiceServer) GetArticle(context.Context, *ListArticleRequest) (*ListArticleResponse, error) {
...
func _ArticleService_GetArticle_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/rpc.ArticleService/GetArticle",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ArticleServiceServer).GetArticle(ctx, req.(*ListArticleRequest))
	}
	return interceptor(ctx, in, info, handler)
}

var _ArticleService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "rpc.ArticleService",
